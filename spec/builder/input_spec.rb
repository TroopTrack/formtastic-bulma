...
describe 'FormtasticBulma::FormBuilder#input' do
  ...
  describe 'arguments and options' do
      ...
      it 'should call the corresponding input class with .to_html' do
        [:select, :time_zone, :radio, :date_select, :datetime_select, :time_select, :boolean, :check_boxes, :hidden, :string, :password, :number, :text, :file].each do |input_style|
          ...
          semantic_form_for(@new_post) do |builder|
            ...
            input_constant = "FormtasticBulma::Inputs::#{input_class}".constantize
    ...
    describe ':hint option' do
      ...
      describe 'when provided' do
        ...
        context "defaults" do
          before do
            @default_block_hint_class = FormtasticBulma::FormBuilder.default_block_hint_class
          end
          after do
            FormtasticBulma::FormBuilder.default_block_hint_class = @default_block_hint_class
          end
          it 'should have a custom hint class defaulted for all forms' do
            hint_text = "this is the title of the post"
            FormtasticBulma::FormBuilder.default_block_hint_class = "custom-hint-class"
            concat(semantic_form_for(@new_post) do |builder|
              concat(builder.input(:title, :hint => hint_text))
            end)
            output_buffer.should have_tag("form div span.custom-hint-class", hint_text)
  ...
  describe 'instantiating an input class' do
    ...
    describe 'when it searching for new input defined with namespace' do
      context 'on production enviroment' do
        ...
        it 'should use FormtasticBulma::Inputs as default scope' do
          stub_const 'FormtasticBulma::Inputs::NewStringInput', formtastic_bootstrap_input
        ...
        it 'should using Formtastic::Inputs namespace if there is no class in FormtasticBulma::Inputs' do
        ...
        it 'should prefate FormtasticBulma namespace to Formtastic' do
          stub_const 'FormtasticBulma::Inputs::NewStringInput',
